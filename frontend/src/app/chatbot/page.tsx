...
async function interactChatbot(input_user: string, address: string) {
  try {
    const response = await api.post(
      "http://localhost:5500/chatbot/interact", // TODO: Change to deployed URL
      {
        input_user,
        address,
        helius_key: "d8c43267-ec7d-4930-8668-5039b78bdf89", // TODO: Unmock that
        openai_key: "OPEN_AI",
      },
      {
        headers: {
          ...
          <div>
            <Modal title="Access Denied" redirectPath="/" show={true}>
              <p className="text-gray-300">
                ...
                of the chatbot. Minimum 50,000 $SWQUERY tokens are required to
                access the chatbot.
              </p>
            </Modal>
          </div>
