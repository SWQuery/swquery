    ...
    <div className="relative flex flex-col h-screen overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col h-screen bg-black/70 backdrop-blur-md">
        ...
        {isAccessLoading ? (
                              ...
                              >
                                ...
                                <div className="relative glow-border">
                                  <textarea
                                    ...
                                    className="rounded-lg w-full h-64 text-md bg-transparent border-2 border-transparent bg-clip-padding focus:outline-none focus:ring-0 transition-shadow p-4 resize-none relative z-10"
                                    rows={8}
                                  ...
                                  <div className="absolute right-4 bottom-4 z-20">
                                    <Button
                                      type="submit"
                                      className="bg-gradient-to-r from-[#9C88FF] to-[#6C5CE7] hover:scale-105 text-white p-2 rounded-full flex items-center justify-center transition-transform"
                                      disabled={isLoading}
                                    >
                                      {isLoading ? (
          ...
          <div>
            <Modal title="Access Denied" redirectPath="/" show={true}>
              <p className="text-gray-300">
                You don&apos;t own $SWQUERY tokens to access the Alpha version
                of the chatbot. Minimum 20,000 $SWQUERY tokens are required to
                access the chatbot.
              </p>
            </Modal>
          </div>
