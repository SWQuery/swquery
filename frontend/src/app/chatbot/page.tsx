					...
					<div>
						...
						>
							<p className="text-gray-300">
								You don&apos;t own $SWQUERY tokens to access the Alpha version of the chatbot. Minimum 50,000 $SWQUERY tokens are required to access the chatbot.
							</p>
						</Modal>
					</div>
				)}
...
export const useTokenAccess = (tokenMintAddress: string, rpcUrl: string) => {
	...
	return { hasAccess, isLoading }; // Return both values
};
