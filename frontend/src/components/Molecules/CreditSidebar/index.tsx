	...
	const getUSDCValue = async () => {
		const options = {
			...
			headers: {
				...
				"x-cg-demo-api-key": "CG-8f7oxzUzNUhz2GvJzWyQiE9T",
			},
		};
		...
		<AnimatePresence>
			{isOpen && (
				<motion.div
					...
					style={{
						background:
							"linear-gradient(135deg, #0A0A0A 30%, #101010 100%)",
					...
					<div className="p-6 h-full flex flex-col relative">
						...
						<div className="flex flex-col items-start mb-8 mt-2">
							...
							<p className="text-sm text-gray-400 leading-relaxed">
								Purchase additional credits with USDC. Your
								credits balance will update automatically.
							</p>
						</div>
