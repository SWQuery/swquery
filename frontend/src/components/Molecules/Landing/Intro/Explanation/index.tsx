        ...
        >
            ...
            >
                <div className="flex items-center space-x-4">
                    ...
                    <span className="text-base md:text-lg">Simplified Data Extraction</span>
                </div>
                <div className="flex items-center space-x-4">
                    <div className="bg-gradient-to-r from-[#6C5CE7] to-[#2D88E6] p-2 rounded-full shadow-md">
                        <Layers className="text-black" size={24} />
                    </div>
                    <span className="text-base md:text-lg">Intelligent Data Transformation</span>
                </div>
                <div className="flex items-center space-x-4">
                    <div className="bg-gradient-to-r from-[#9C88FF] to-[#6C5CE7] p-2 rounded-full shadow-md">
                        <ZoomIn className="text-black" size={24} />
                    </div>
                    <span className="text-base md:text-lg">Comprehensive Data Visualization</span>
                </div>
            </motion.div>
