		...
		<div className="py-24 bg-gradient-to-b text-white relative overflow-hidden">
			<div className="container mx-auto text-center relative">
				<h2 className="text-5xl font-extrabold mb-12">
					SWQuery SDK Workflow
				</h2>
				<p className="mb-16 text-lg text-gray-400 leading-relaxed">
					Discover how SWQuery streamlines blockchain data extraction
					through AI and intuitive workflows.
				</p>
				...
				<div className="relative flex justify-center">
					<div className="w-full max-w-5xl relative">
						...
						<div
							className="absolute top-0 left-0 w-full h-full flex justify-between items-center px-4 md:px-12 lg:px-16"
