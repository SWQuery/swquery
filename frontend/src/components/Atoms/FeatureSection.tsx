      ...
      <div className="container mx-auto px-4">
        <div className={`flex flex-col ${reversed ? 'md:flex-row-reverse' : 'md:flex-row'} items-center gap-10`}>
          ...
          {codeSnippet && (
            ...
            >
              <div className={`flex justify-center items-center w-full overflow-x-hidden ${firaCode.className}`}>
                <div className="w-full bg-[#1E1E1E] rounded-xl p-1 shadow-lg">
                  <div className="bg-[#141414] rounded-lg">
                    <div className="flex justify-between items-center p-2 border-b border-[#9945FF]/20">
                      ...
                      <span className="text-xs text-gray-400">{codeFileName}</span>
                    </div>
