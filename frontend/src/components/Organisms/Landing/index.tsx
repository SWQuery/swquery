...
import { ChevronRight, Globe, Brain, PieChart, ShieldCheck } from 'lucide-react'
...
export const Landing = () => {
    const itemsHowItWorks = [
        {
            ...
            description: 'Use your Solana wallet to integrate with the SWquery system.',
        },
        {
            Icon: ChevronRight,
            iconColor: '#9945FF',
    ...
    const itemsFeatures = [
        {
            ...
            iconColor: '#14F195',
            title: 'Advanced AI',
            description: 'Intelligent solutions for automated analysis of complex data.',
        ...
        },
        {
            ...
            description: 'Seamless integration with the Solana network anywhere in the world.',
            className: 'hover:scale-105 transition-transform'
        }
    ];
	...
	return (
		<div className='min-h-screen bg-gradient-to-b from-[#0A0A0A] to-[#101010] text-white'>
			<Navbar />
			<Intro />
            <Section title='How It Works' items={itemsHowItWorks} columns={3} textAlign='center' />
            <Section title='Features' items={itemsFeatures} columns={3} textAlign='center' />
            <Section title='Technical Benefits' items={itemsTechnicalBenefits} columns={2} textAlign='left' />
            <Footer />
		</div>
	)
}
