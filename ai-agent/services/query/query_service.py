...
def query_generator_openai(input_user: str, address: str) -> dict:
    try:
        print(f"Processing query: {input_user} for address: {address}")

        openai_key = settings.openai_key_secret
        ...
        print(f"Error in query_generator_openai: {str(e)}")
