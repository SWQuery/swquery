...
def query_generator_openai(user_input: str, wallet: str):
    system_prompt = (
        ...
        "     - `biggest`: Returns the biggest value of the field.\n"
        "     - `smallest`: Returns the smallest value of the field.\n"
        ...
        "   - Example usage of these operators in filters:\n"
        "     {\n"
        "         \"filters\": [\n"
        "             { \"field\": \"status\", \"operator\": \"equals\", \"value\": \"success\" },\n"
        "             { \"field\": \"fee\", \"operator\": \"greater_than\", \"value\": 10000 },\n"
        "             { \"field\": \"timestamp\", \"operator\": \"between\", \"value\": [1609459200, 1640995200] }\n"
        "         ]\n"
        "     }\n\n"
        ...
        "       \"status\": \"success\"\n"
        "   }\n\n"
        "   **Example 2:** Query: \"Show me transactions in the last 7 days where the fee was between 0.2 and 0.5 SOL.\"\n"
        "   {\n"
        "       \"response\": \"getRecentTransactions\",\n"
        "       \"params\": {\n"
        "           \"address\": \"wallet_address\",\n"
